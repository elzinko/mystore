...
mystoreApp.controller('LanguageController', function ($scope, $translate, LanguageService) {
...
mystoreApp.controller('MenuController', function ($scope) {
    });

mystoreApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
mystoreApp.controller('LogoutController', function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    });

mystoreApp.controller('SettingsController', function ($scope, Account) {
        $scope.success = null;
        $scope.error = null;
...
mystoreApp.controller('RegisterController', function ($scope, $translate, Register) {
        $scope.success = null;
        $scope.error = null;
...
mystoreApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
mystoreApp.controller('PasswordController', function ($scope, Password) {
        $scope.success = null;
        $scope.error = null;
        $scope.doNotMatch = null;
...
mystoreApp.controller('SessionsController', function ($scope, resolvedSessions, Sessions) {
        $scope.success = null;
        $scope.error = null;
 ...
 mystoreApp.controller('TrackerController', ['AccessToken'], function ($scope, AccessToken) {
...
mystoreApp.controller('HealthController', function ($scope, HealthCheckService) {
...
mystoreApp.controller('ConfigurationController', function ($scope, resolvedConfiguration) {
    $scope.configuration = resolvedConfiguration;
});

mystoreApp.controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
        $scope.metrics = {};
...
mystoreApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
mystoreApp.controller('AuditsController', function ($scope, $translate, $filter, AuditsService) {
