package fr.couderc.thomas.sarl.mystore.config.oauth2;

import fr.couderc.thomas.sarl.mystore.domain.OAuth2AuthenticationAccessToken;
import fr.couderc.thomas.sarl.mystore.domain.OAuth2AuthenticationRefreshToken;
