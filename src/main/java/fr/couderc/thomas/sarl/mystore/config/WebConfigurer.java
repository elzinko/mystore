...
import fr.couderc.thomas.sarl.mystore.web.filter.CachingHttpHeadersFilter;
import fr.couderc.thomas.sarl.mystore.web.filter.StaticResourcesProductionFilter;
import fr.couderc.thomas.sarl.mystore.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "fr.couderc.thomas.sarl.mystore.web.websocket");
